...
namespace GitIssue.Tests
{
    public static class Moqs
    {
        public static IReadOnlyIssue Issue
        {
            get
            {
                Mock<IReadOnlyIssue> moq = new Mock<IReadOnlyIssue>(MockBehavior.Strict);
                return moq.Object;
            }
        }
        ...
        public static IIssueManager IssueManager
        {
            get
            {
                Mock<IIssueManager> moq = new Mock<IIssueManager>(MockBehavior.Strict);
                return moq.Object;
            }
        }
        ...
        {
            Mock<IField> moq = new Mock<IField>(MockBehavior.Strict);
        ...
        {
            Dictionary<FieldKey, IField> fields = new Dictionary<FieldKey, IField>();
        ...
        public static IReadOnlyIssue CreateIssue(IReadOnlyDictionary<FieldKey, IField> fields)
        {
            ...
            moq.Setup(i => i.TryGetValue(It.IsAny<FieldKey>(), out tryGetResult))
                .Callback(new MockOutDelegate<FieldKey, IField>((key, out output) =>
                {
                    tryGetFieldKey = key;
